...
function Argmin_CostFunction(a::agent, menge::crowd, geometrie::geometry, system_size, N = 50000)
    ...
    for i in 1:N
        ...
        score_help = Calc_Score(a, vel .* heading, menge, geometrie, system_size)
