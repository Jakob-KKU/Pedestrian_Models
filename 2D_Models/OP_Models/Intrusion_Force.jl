...
IN(a::agent, b::agent, system_size) = ((r_soc(a, b, system_size) - 2/3*l(a, b))/(d(a, b, system_size) - 2/3*l_IN(a, b)))
IN(a::agent, b::element, system_size) = ((r_soc(a, b, system_size) - 2/3*l(a, b))/(d(a, b, system_size)  - 2/3*l_IN(a, b)))
